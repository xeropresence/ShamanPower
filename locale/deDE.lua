local L = LibStub("AceLocale-3.0"):NewLocale("ShamanPower", "deDE", false, false)
if not L then return end
L["--- End of assignments ---"] = "--- Ende der Zuweisungen ---"
L["--- Paladin assignments ---"] = "--- Paladin-Zuweisungen ---"
L["...with Normal..."] = "... mit ..."
...
L["[Enable/Disable] ShamanPower"] = "[Aktiviere / Deaktiviere] ShamanPower"
L["[Enable/Disable] ShamanPower in Party"] = "[Aktiviere / Deaktiviere] ShamanPower in einer Gruppe"
L["[Enable/Disable] ShamanPower while Solo"] = "[Aktiviere / Deaktiviere] ShamanPower, wenn allein unterwegs"
L["[Enable/Disable] Righteous Fury"] = "[Aktiviere / Deaktiviere] Zorn der Gerechtigkeit"
L["[Enable/Disable] The Aura Button"] = "[Aktiviere / Deaktiviere] die Aura-Schaltfläche"
L["[Enable/Disable] The Auto Buff Button"] = "[Aktiviere / Deaktiviere] die Auto-Buff-Schaltfläche"
L["[Enable/Disable] The Drag Handle"] = "[Aktiviere / Deaktiviere] den Anfasser."
L["[Enable/Disable] The Seal Button"] = "[Aktiviere / Deaktiviere] die Siegel-Schaltfläche"
L["[Show/Hide] Minimap Icon"] = "Minimap-Symbol [einblenden / ausblenden]"
L["[Show/Hide] The ShamanPower Tooltips"] = "[Zeige / Verstecke] die ShamanPower-Tooltips"
L["a Normal Blessing from:"] = "ein normaler Segen von:"
L["Aura Button"] = "Aura-Schaltfläche"
L["Aura Tracker"] = "Aura-Überwachung"
...
Raid-Vorlage für die Zuweisung verwenden.]=]
L["Auto-Assign"] = "Auto-Zuweisung"
L["Auto-Buff Main Assistant"] = "Auto-Buff-Hauptassistent"
L["Auto-Buff Main Tank"] = "Haupttank automatisch buffen."
L["AUTOKEY1_DESC"] = "Tastenzuweisung zum automatischen buffen normaler Segen."
L["AUTOKEY2_DESC"] = "Tastenzuweisung zum automatischen buffen großer Segen."
L["Background Textures"] = "Hintergrundtexturen"
L["Blessing Assignments Scale"] = "Skalierung der Buff-Zuweisungs-Übersicht"
L["BLESSING_REPORT_TOOLTIP"] = "Alle Segens-Zuweisungen an den Raid- oder Gruppenkanal melden."
L["Blessings Report"] = "Segens-Bericht"
L["Blessings Report Channel"] = "Kanal für Segen-Bericht"
L["Borders"] = "Rahmen"
L["Buff Button | Player Button Layout"] = "Buff- /  Spieler-Schaltflächen Layout"
L["Buff Duration"] = "Buff-Dauer beachten"
L["Buttons"] = "Schaltflächen"
L["can be assigned"] = "kann zugewiesen werden"
L["Change global settings"] = "Globale Einstellungen ändern"
L["Change the Button Background Textures"] = "Ändert die Hintergrund-Textur der Schaltflächen"
L["Change the Button Borders"] = "Passe die Schaltflächen-Rahmen an."
L["Change the button settings"] = "Schaltflächen-Einstellungen ändern"
L["Change the status colors of the buff buttons"] = "Ändere die Statusfarben der Buff-Schaltflächen"
L["Change the way ShamanPower looks"] = "Ändere das Aussehen von ShamanPower"
L["Class & Player Buttons"] = "Klassen- und Spieler-Schaltflächen"
...
L["Enable ShamanPower"] = "ShamanPower aktivieren"
L["Free Assignment"] = "Freie Zuweisung"
...
L["Horizontal Right | Up"] = "Horizontal rechts | oben"
L["If this option is disabled it will also disable the Player Buttons and you will only be able to buff using the Auto Buff button."] = [=[Achtung: Wenn diese Option deaktiviert ist, werden auch die 
Spieler-Schaltflächen deaktiviert, und es kann nurnoch via 
Auto-Buff-Schaltfläche gebuffed werden, sofern aktiviert.]=]
...
L["If you enable this option ShamanPower will automatically over-write a Greater Blessing with a Normal Blessing on players marked with the |cffffd200Main Assistant|r role in the Blizzard Raid Panel. This is useful to avoid blessing the |cffffd200Main Assistant|r role with a Greater Blessing of Salvation."] = "Wenn du diese Option aktivierst, überschreibt ShamanPower automatisch einen großen Segen mit einem normalen Segen für Spieler, die mit der Rolle |cffffd200Haupt-Assistent|r im Blizzard Raid Panel gekennzeichnet sind. Dies ist nützlich, um z.B. die Ausführung eines Segen der Rettung auf die Rolle des |cffffd200Haupt-Assistenten|r zu vermeiden."
--[[Translation missing --]]
...
L["If you enable this option ShamanPower will automatically over-write a Greater Blessing with a Normal Blessing on players marked with the |cffffd200Main Tank|r role in the Blizzard Raid Panel. This is useful to avoid blessing the |cffffd200Main Tank|r role with a Greater Blessing of Salvation."] = "Wenn du diese Option aktivierst, überschreibt ShamanPower automatisch einen großen Segen mit einem normalen Segen für alle Spieler, die mit der Rolle |cffffd200Haupttank|r im Blizzard Raid Panel gekennzeichnet sind. Dies ist nützlich, um zu vermeiden, dass der |cffffd200Haupttankr  mit einem großen Segen der Rettung gebuffed wird. "
...
Horizontal [Auf / Ab]]=]
L["Main ShamanPower Settings"] = "ShamanPower Haupt-Einstellungen"
L["Main Tank / Main Assist Roles"] = "Haupttank / Hauptassistenzrollen"
L["MAIN_ROLES_DESCRIPTION"] = [=[Diese Optionen können dazu verwendet werden, um automatisch alternative normale Segen für jeden großen Segen zuzuweisen, der Kriegern, Druiden oder Paladinen |cffff0000|r zugewiesen ist.

Normalerweise werden die Rollen Haupttank und Hauptassistent verwendet, um Haupttanks und Off-Tanks (Hauptassistent) zu identifizieren. Einige Gilden weisen jedoch die Haupttankrolle sowohl Haupttanks als auch Off-Tanks zu und weisen Heilern die Rolle des Hauptassistenten zu.
...
L["None"] = "Keine"
L["None Buffed"] = "Keine gebuffed"
L["Options"] = "Optionen"
L["OPTIONS_BUTTON_TOOLTIP"] = "Öffnet die ShamanPower Optionen."
...
L["ShamanPower Buttons Scale"] = "Skalierung der Buff-Schaltflächen"
L["ShamanPower Classic"] = "ShamanPower Classic"
L["Partially Buffed"] = "Teilweise gebuffed"
L["Player Buttons"] = "Spieler-Schaltflächen"
L["PP_CLEAR_TOOLTIP"] = [=[Löscht allen Zuweisungen für sich selbst,
...
|cffffd200 [Keine]|r Wählt den Kanal automatisch, basierend auf der Gruppenzusammensetzung aus. (Gruppe/ Schlachtzug)

|cffffd200 [Kanalliste]|r Eine automatisch aufgefüllte Kanalliste basierend auf den Kanälen, denen der Speiler beigetreten ist. Standardkanäle wie Handel, Allgemein usw. werden automatisch aus der Liste herausgefiltert.

|cffffff00Hinweis: Wenn du deine Kanalreihenfolge änderst, musst du deine Benutzeroberfläche neu laden und überprüfen, ob der richtige Kanal zugewiesen ist.|r]=]
L["Reset all ShamanPower frames back to center"] = "Alle ShamanPower-Frames zurück in die Mitte setzen"
L["Reset Frames"] = "PP Position zurücksetzen"
L["RESIZEGRIP_TOOLTIP"] = [=[Um die Größe zu ändern, halte die linke Maustaste gedrückt.
Die rechte Maustaste setzt die Größe auf den Standardwert zurück.]=]
L["Righteous Fury"] = "Zorn der Gerechtigkeit"
L["Salv in Combat"] = "Rettung im Kampf"
L["SALVCOMBAT_OPTION_TOOLTIP"] = [=[Wenn du diese Option aktivierst, kannst du Krieger, Druiden und Paladine auch im Kampf mit dem großen Segen der Rettung buffen.

|cffffff00Hinweis: Diese Einstellung gilt NUR für Schlachtzugsgruppen, da in unserer aktuellen Kultur viele Tanks zum abbrechen von Buffs Skripte / Addons verwenden, die nicht im Kampf ausgeführt werden können. Diese Option ist im Grunde genommen eine Sicherheit, um zu verhindern, dass ein Tank während des Kampfes versehentlich mit Rettung gebuffed wird.|r]=]
L["Seal Button"] = "Siegel-Schaltfläche"
L["Seal Tracker"] = "Siegel Überwachung"
L["Select the Aura you want to track"] = "Wähle die Aura aus, die du verfolgen möchtest."
...
L["Smart Buffs"] = "Intelligente Buffs"
L["This allows you to adjust the overall size of the Blessing Assignments Panel"] = "Hiermit kann die Größe der Buff-Zuweisungs-Übersicht angepasst werden."
L["This allows you to adjust the overall size of the ShamanPower Buttons"] = "Hiermit kann die Größe der Buff-Schaltflächen angepasst werden."
L["Use in Party"] = "In Gruppe verwenden"
L["Use when Solo"] = "Aktiv, wenn allein unterwegs"
L["Vertical Down | Left"] = "Vertikal nach unten | Links"
