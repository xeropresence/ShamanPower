...
L["...with Normal..."] = "... avec Normal ..."
L["[|cffffd200Enable|r/|cffffd200Disable|r] The Aura Button or select the Aura you want to track."] = "[|cffffd200Enable|r / |cffffd200Disable|r] Le bouton Aura ou sélectionnez l'aura que vous souhaitez utiliser."
L["[|cffffd200Enable|r/|cffffd200Disable|r] The Auto Buff Button or [|cffffd200Enable|r/|cffffd200Disable|r] Wait for Players."] = "[|cffffd200Enable|r / |cffffd200Disable|r] Le bouton de buff automatique ou [|cffffd200Enable|r / |cffffd200Disable|r] Attendre les joueurs."
...
L["Auto-Buff Main Assistant"] = "Buff automatique des assist raid"
L["Auto-Buff Main Tank"] = "Auto-Buff des tanks"
...
L["Background Textures"] = "Textures d'arrière-plan"
L["Blessing Assignments Scale"] = "Échelle de la fenêtre d'affectation"
L["BLESSING_REPORT_TOOLTIP"] = "Envoyer un rapport des attributions actuelle en canal groupe ou raid. "
L["Blessings Report"] = "Rapport"
L["Blessings Report Channel"] = "Canal de rapports des bénédictions"
L["Borders"] = "Bordures"
L["Buff Button | Player Button Layout"] = "Bouton Buff | Disposition des boutons des joueurs"
L["Buff Duration"] = "Durée du buff"
L["Buttons"] = "Boutons"
L["can be assigned"] = "peut être attribué"
L["Change global settings"] = "Modifier les paramètres globaux"
L["Change the Button Background Textures"] = "Modifier les textures d'arrière-plan des boutons"
...
L["Horizontal Right | Up"] = "Horizontal Droite | Haut"
L["If this option is disabled it will also disable the Player Buttons and you will only be able to buff using the Auto Buff button."] = "Si cette option est désactivée, elle désactivera également les boutons individuel des joueurs et vous ne pourrez buff que via le bouton Auto Buff."
...
L["Salv in Combat"] = "Bénédiction de salut pendant le combat"
L["SALVCOMBAT_OPTION_TOOLTIP"] = [=[Si vous activez cette option, vous pourrez buff les guerriers, les druides et les paladins avec une bénédiction de salut supérieure pendant le combat.
...
L["Show Pets"] = "Montrer les familiers"
...
L["SHOWPETS_OPTION_TOOLTIP_VANILLA"] = [=[Si vous activez cette option, les animaux de compagnie apparaîtront dans leur propre classe.
